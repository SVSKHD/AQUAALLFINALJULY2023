        ...
        <>
            <Card className="user-card text-white mb-4">
                <Card.Body>
                    ...
                    <Card.Title className="user-card-name text-center">{props.name? props.name : "Aquakart"}</Card.Title>
                    </div>
                    <Card.Body className="bg-white user-card-body text-center">
                    <Card.Link className="text-dark"><FaShoppingBag size={25}/></Card.Link>
